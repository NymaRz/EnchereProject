...
<div id="page-encherir">
	...
	<form action="" method="POST">
		...
		<%-- <label class="enchere-min" for="montantEnchere">${articleVendu.enchereMin}</label>  --%>
			<input name="montantEnchere" id="montantEnchere" type="number" value="${minEnchere}" min="${minEnchere }" step="${articleVendu.enchereMin }"/>
			 <button class="montantEnchere-increment">+ 100</button><button class="montantEnchere-decrement">- 100</button>
